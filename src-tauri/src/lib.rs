...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            tracing::info!(
                chat_model = %settings_loaded.chat_model,
                embedding_model = %settings_loaded.embedding_model,
                sandbox = ?settings_loaded.default_sandbox,
                "settings loaded"
            );
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::actions::agent_run_compiler_check,
            // Activity feed
