 ...
 * Supports dual-editor Monaco Diff view for agent previews.
 */
...
export function MonacoPane() {
  ...
  const isDiffMode =
    active?.agentPreview &&
    active.diffView &&
    active.originalContents !== undefined;
        ...
        {active ? (
          isDiffMode ? (
            <DiffEditor
              ...
              original={active.originalContents}
              modified={active.contents}
            ...
            <Editor
              ...
              options={{
                ...
                readOnlyMessage: {
                  value:
                    "This is an agent preview. Approve the action to write it to disk.",
                },
                fontFamily:
                  "'JetBrains Mono', ui-monospace, Consolas, Cascadia Code, monospace",
                fontLigatures: true,
