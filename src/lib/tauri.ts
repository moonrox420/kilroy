...
export const term = {
  ...
  onIdleTimeout: (id: string, cb: () => void): Promise<UnlistenFn> =>
    listen<void>(`terminal://${id}/idle_timeout`, () => cb()),
};
...
export type ActionKind = "file_write" | "file_patch" | "file_change" | "shell";
...
export const agent = {
  ...
  runCompilerCheck: () =>
    invoke<CompilerCheckResult | null>("agent_run_compiler_check"),
};
